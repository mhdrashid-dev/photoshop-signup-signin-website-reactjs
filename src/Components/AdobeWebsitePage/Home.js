...
function Home() {
  return (
    <div className='w-full min-h-[60vh] lg:min-h-[80vh] bg-[rgb(245,245,245)] lg:relative lg:bg-transparent lg:flex lg:justify-start lg:items-center'>
      ...
      <div className="content p-5 md:px-16 lg:h-full lg:container lg:mx-auto lg:flex lg:flex-col xl:px-32">
